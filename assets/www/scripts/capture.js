...
function captureSuccess(files) {
	// more than 1 file might be returned so perform a loop and upload all of them
...
function uploadMediaFile(file) {
	...
	uploadOptions.fileName = currentPhoto.substr(file.lastIndexOf('/')+1); // instead of 'currentPhoto' may be 'file.fullPath'
